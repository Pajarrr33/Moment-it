            ...
            <div class="grid grid-cols-1 bg-white sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 h-100 pr-5 pl-5 w-3/4 mx-auto rounded-lg">
                ...
                <div class="col-span-1 my-7">
                    ...
                    <div class="relative mt-5">
                        ...
                        <textarea name="deskripsi" id="" placeholder="Tambahkan deskripsi" class="resize-none overflow-y-hidden font-poppins border border-black p-4 w-full h-24 rounded-3xl text-black"></textarea>
